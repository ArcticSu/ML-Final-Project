...
if __name__ == "__main__":
    ...
    # TextCNN
    print("Training XMLCNN...")
    textcnn_model = XMLCNN(max_words, max_len, len(genre_classes))
    results['TextCNN'] = train_and_evaluate_deep_learning(X_train, X_test, y_train, y_test, textcnn_model, "XMLCNN")
